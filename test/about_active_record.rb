...
class AboutActiveRecord < Test::Unit::TestCase
  ...
  context "Given a Library and some books, " do
    setup do
      ...
      @war_peace.reload
      @leo.reload
      # 9 35 65   8 7 6 5 4 3 2   11 10 9 8 7 6 5 4 3 2 
    end
    ...
    context "War and Peace" do
      ...
      should "have many authors" do
        ...
        assert_equal Author, @war_peace.authors.class
        assert_equal 3, @war_peace.authors.length
        assert_equal "Leo Tolstoy", @war_peace.authors.first.name
        assert_equal true, @war_peace.respond_to?(:author_id)
        assert_equal true, @war_peace.respond_to?(:author_book_id)
        assert_equal true, @war_peace.authors.first.respond_to?(:book_id)
