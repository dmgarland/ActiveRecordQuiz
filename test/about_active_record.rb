  ...
  context "Given a Library and some books, " do
    ...
    context "the library" do
      should "have many books" do
        ...
        assert_equal @library.id, @library.books.first.library.id
        assert_equal "New York Public Library", @library.books.first.library.name
      end
    ...
    context "War and Peace" do
      ...
      should "have many authors" do
        ...
        assert_equal @leo.name, @war_peace.authors.first.name
        ...
        #(book doesn't has 'book_id', just an id)
